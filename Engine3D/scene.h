...
public:
	...
	inline void setSturn(char turn) { currentTurn = turn; }

	inline char getTurn() {
		return this->currentTurn;
	}

	inline void setQueueNewOperation(char operation) { operation_qChar.push(operation); }
	...
	std::queue <glm::mat4> operation_q;//glm::mat4(1);
	std::queue <char> operation_qChar;
	std::queue <int> cubes_id;
